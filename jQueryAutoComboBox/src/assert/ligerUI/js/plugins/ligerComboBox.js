    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _setCancelable: function (value)
        {
            ...
            g.unselect.hover(function () {
                ...
                g.clear();
				$(".l-selected").removeClass("l-selected");   //maria20150325
            });
        },
        ...
        removeItemcb: function (data)
        {
            var g = this, p = this.options;
			var id=data.id
            $(".l-box-select-inner").find("tr[value="+id+"]").remove();
        },
        insertItemcb: function (data, index)
		{
            var g = this, p = this.options;
            g.data = g.data || [];
        ...
        addItemcb: function (data)
		{
            var g = this, p = this.options;
            g.insertItemcb(data, (g.data || []).length);
        },
